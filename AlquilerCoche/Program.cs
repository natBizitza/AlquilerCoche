    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                weeks = totalDays / DAYS_PER_WEEK; // para calcular las semanas dividimos dias totales por dís en una semana
                days = totalDays % DAYS_PER_WEEK; // para calcular los dís restantes hacemos % dís en una semana
                payedDays = totalDays - weeks; // oferta de un dí menos de alquiler pagado por semana alquilada
                cost = payedDays * PRICE_PER_DAY; // el coste es los dís que pagamos por el precio por dí del alquiler
                Console.WriteLine();
